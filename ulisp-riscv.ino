...
enum type { ZZERO=0, SYMBOL=2, CODE=4, NUMBER=6, NUMHEX=8, STREAM=10, CHARACTER=12, FLOAT=14, STRING=16, PAIR=18 };  // STRING and PAIR must be last
enum token { UNUSED, BRA, KET, QUO, DOT };
enum stream { SERIALSTREAM, I2CSTREAM, SPISTREAM, SDSTREAM, WIFISTREAM, GFXSTREAM };
...
FORMILLIS, WITHSERIAL, WITHI2C, WITHSPI, WITHSDCARD, WITHGFX, DEFCODE, TAIL_FORMS, PROGN, IF, COND, WHEN,
UNLESS, CASE, AND, OR, FUNCTIONS, NOT, NULLFN, CONS, ATOM, LISTP, CONSP, SYMBOLP, BOUNDP, SET, STREAMP,
EQ, CAR, FIRST, CDR, REST, CAAR, CADR, SECOND, CDAR, CDDR, CAAAR, CAADR, CADAR, CADDR, THIRD, CDAAR,
CDADR, CDDAR, CDDDR, LENGTH, LIST, REVERSE, NTH, ASSOC, MEMBER, APPLY, FUNCALL, APPEND, MAPC, MAPCAR,
...
DIGITALWRITE, ANALOGREAD, ANALOGWRITE, DELAY, MILLIS, SLEEP, NOTE, EDIT, PPRINT, PPRINTALL, REQUIRE,
...
object *quote (object *arg) {
  cons(symbol(QUOTE),cons(arg,NULL));
}
...
const char ppspecial[ppspecials] PROGMEM = 
  { DOTIMES, DOLIST, IF, SETQ, TEE, LET, LETSTAR, LAMBDA, WHEN, UNLESS, WITHI2C, WITHSERIAL, WITHSPI, WITHSDCARD, FORMILLIS, WITHGFX };
...
object *tf_cond (object *args, object *env) {
  while (args != NULL) {
    ...
    if (test != nil) {
      if (forms == NULL) return cons(symbol(QUOTE),cons(test,NULL)); else return tf_progn(forms, env);
    }
    args = cdr(args);
  }
  return nil;
...
object *fn_drawpixel (object *args, object *env) {
  ...
  lcd.drawPixel(checkinteger(DRAWPIXEL, first(args)), checkinteger(DRAWPIXEL, second(args)), colour);
  return nil;
}
...
object *fn_drawline (object *args, object *env) {
  ...
  lcd.drawLine(params[0], params[1], params[2], params[3], colour);
  return nil;
}
...
object *fn_drawrect (object *args, object *env) {
  ...
  lcd.drawRect(params[0], params[1], params[2], params[3], colour);
  return nil;
}
...
object *fn_fillrect (object *args, object *env) {
  ...
  lcd.fillRect(params[0], params[1], params[2], params[3], colour);
  return nil;
}
...
object *fn_drawcircle (object *args, object *env) {
  ...
  lcd.drawCircle(params[0], params[1], params[2], colour);
  return nil;
}
...
object *fn_fillcircle (object *args, object *env) {
  ...
  lcd.fillCircle(params[0], params[1], params[2], colour);
  return nil;
}
...
object *fn_drawroundrect (object *args, object *env) {
  ...
  lcd.drawRoundRect(params[0], params[1], params[2], params[3], params[4], colour);
  return nil;
}
...
object *fn_fillroundrect (object *args, object *env) {
  ...
  lcd.fillRoundRect(params[0], params[1], params[2], params[3], params[4], colour);
  return nil;
}
...
object *fn_drawtriangle (object *args, object *env) {
  ...
  lcd.drawTriangle(params[0], params[1], params[2], params[3], params[4], params[5], colour);
  return nil;
}
...
object *fn_filltriangle (object *args, object *env) {
  ...
  lcd.fillTriangle(params[0], params[1], params[2], params[3], params[4], params[5], colour);
  return nil;
}
...
object *fn_drawchar (object *args, object *env) {
  ...
  lcd.drawChar(checkinteger(DRAWCHAR, first(args)), checkinteger(DRAWCHAR, second(args)), checkchar(DRAWCHAR, third(args)),
    colour, bg, size);
  return nil;
}
...
object *fn_setcursor (object *args, object *env) {
  (void) env;
  lcd.setCursor(checkinteger(SETCURSOR, first(args)), checkinteger(SETCURSOR, second(args)));
  return nil;
}

object *fn_settextcolor (object *args, object *env) {
  (void) env;
  if (cdr(args) != NULL) lcd.setTextColor(checkinteger(SETTEXTCOLOR, first(args)), checkinteger(SETTEXTCOLOR, second(args)));
  else lcd.setTextColor(checkinteger(SETTEXTCOLOR, first(args)));
  return nil;
}

object *fn_settextsize (object *args, object *env) {
  (void) env;
  lcd.setTextSize(checkinteger(SETTEXTSIZE, first(args)));
  return nil;
}

object *fn_settextwrap (object *args, object *env) {
  (void) env;
  lcd.setTextWrap(first(args) != NULL);
  return nil;
}
...
object *fn_setrotation (object *args, object *env) {
  (void) env;
  lcd.setRotation(checkinteger(SETROTATION, first(args)));
  return nil;
}

object *fn_invertdisplay (object *args, object *env) {
  (void) env;
  lcd.invertDisplay(first(args) != NULL);
  return nil;
}
...
const char string30[] PROGMEM = "with-gfx";
...
const char string49[] PROGMEM = "boundp";
const char string50[] PROGMEM = "set";
const char string51[] PROGMEM = "streamp";
const char string52[] PROGMEM = "eq";
const char string53[] PROGMEM = "car";
const char string54[] PROGMEM = "first";
const char string55[] PROGMEM = "cdr";
const char string56[] PROGMEM = "rest";
const char string57[] PROGMEM = "caar";
const char string58[] PROGMEM = "cadr";
const char string59[] PROGMEM = "second";
const char string60[] PROGMEM = "cdar";
const char string61[] PROGMEM = "cddr";
const char string62[] PROGMEM = "caaar";
const char string63[] PROGMEM = "caadr";
const char string64[] PROGMEM = "cadar";
const char string65[] PROGMEM = "caddr";
const char string66[] PROGMEM = "third";
const char string67[] PROGMEM = "cdaar";
const char string68[] PROGMEM = "cdadr";
const char string69[] PROGMEM = "cddar";
const char string70[] PROGMEM = "cdddr";
const char string71[] PROGMEM = "length";
const char string72[] PROGMEM = "list";
const char string73[] PROGMEM = "reverse";
const char string74[] PROGMEM = "nth";
const char string75[] PROGMEM = "assoc";
const char string76[] PROGMEM = "member";
const char string77[] PROGMEM = "apply";
const char string78[] PROGMEM = "funcall";
const char string79[] PROGMEM = "append";
const char string80[] PROGMEM = "mapc";
const char string81[] PROGMEM = "mapcar";
const char string82[] PROGMEM = "mapcan";
...
const char string107[] PROGMEM = "float";
const char string108[] PROGMEM = "floatp";
const char string109[] PROGMEM = "sin";
const char string110[] PROGMEM = "cos";
const char string111[] PROGMEM = "tan";
const char string112[] PROGMEM = "asin";
const char string113[] PROGMEM = "acos";
const char string114[] PROGMEM = "atan";
const char string115[] PROGMEM = "sinh";
const char string116[] PROGMEM = "cosh";
const char string117[] PROGMEM = "tanh";
const char string118[] PROGMEM = "exp";
const char string119[] PROGMEM = "sqrt";
const char string120[] PROGMEM = "log";
const char string121[] PROGMEM = "expt";
const char string122[] PROGMEM = "ceiling";
const char string123[] PROGMEM = "floor";
const char string124[] PROGMEM = "truncate";
const char string125[] PROGMEM = "round";
const char string126[] PROGMEM = "char";
const char string127[] PROGMEM = "char-code";
const char string128[] PROGMEM = "code-char";
const char string129[] PROGMEM = "characterp";
const char string130[] PROGMEM = "stringp";
const char string131[] PROGMEM = "string=";
const char string132[] PROGMEM = "string<";
const char string133[] PROGMEM = "string>";
const char string134[] PROGMEM = "sort";
const char string135[] PROGMEM = "string";
const char string136[] PROGMEM = "concatenate";
const char string137[] PROGMEM = "subseq";
const char string138[] PROGMEM = "read-from-string";
const char string139[] PROGMEM = "princ-to-string";
const char string140[] PROGMEM = "prin1-to-string";
const char string141[] PROGMEM = "logand";
const char string142[] PROGMEM = "logior";
const char string143[] PROGMEM = "logxor";
const char string144[] PROGMEM = "lognot";
const char string145[] PROGMEM = "ash";
const char string146[] PROGMEM = "logbitp";
const char string147[] PROGMEM = "eval";
const char string148[] PROGMEM = "globals";
const char string149[] PROGMEM = "locals";
const char string150[] PROGMEM = "makunbound";
const char string151[] PROGMEM = "break";
const char string152[] PROGMEM = "read";
const char string153[] PROGMEM = "prin1";
const char string154[] PROGMEM = "print";
const char string155[] PROGMEM = "princ";
const char string156[] PROGMEM = "terpri";
const char string157[] PROGMEM = "read-byte";
const char string158[] PROGMEM = "read-line";
const char string159[] PROGMEM = "write-byte";
const char string160[] PROGMEM = "write-string";
const char string161[] PROGMEM = "write-line";
const char string162[] PROGMEM = "restart-i2c";
const char string163[] PROGMEM = "gc";
const char string164[] PROGMEM = "room";
const char string165[] PROGMEM = "save-image";
const char string166[] PROGMEM = "load-image";
const char string167[] PROGMEM = "cls";
const char string168[] PROGMEM = "pinmode";
const char string169[] PROGMEM = "digitalread";
const char string170[] PROGMEM = "digitalwrite";
const char string171[] PROGMEM = "analogread";
const char string172[] PROGMEM = "analogwrite";
const char string173[] PROGMEM = "delay";
const char string174[] PROGMEM = "millis";
const char string175[] PROGMEM = "sleep";
const char string176[] PROGMEM = "note";
const char string177[] PROGMEM = "edit";
const char string178[] PROGMEM = "pprint";
const char string179[] PROGMEM = "pprintall";
const char string180[] PROGMEM = "require";
const char string181[] PROGMEM = "list-library";
const char string182[] PROGMEM = "draw-pixel";
const char string183[] PROGMEM = "draw-line";
const char string184[] PROGMEM = "draw-rect";
const char string185[] PROGMEM = "fill-rect";
const char string186[] PROGMEM = "draw-circle";
const char string187[] PROGMEM = "fill-circle";
const char string188[] PROGMEM = "draw-round-rect";
const char string189[] PROGMEM = "fill-round-rect";
const char string190[] PROGMEM = "draw-triangle";
const char string191[] PROGMEM = "fill-triangle";
const char string192[] PROGMEM = "draw-char";
const char string193[] PROGMEM = "set-cursor";
const char string194[] PROGMEM = "set-text-color";
const char string195[] PROGMEM = "set-text-size";
const char string196[] PROGMEM = "set-text-wrap";
const char string197[] PROGMEM = "fill-screen";
const char string198[] PROGMEM = "set-rotation";
const char string199[] PROGMEM = "invert-display";
...
const tbl_entry_t lookup_table[] PROGMEM = {
  ...
  { string30, sp_withgfx, 1, 127 },
  { string31, sp_defcode, 0, 127 },
  ...
  { string49, fn_boundp, 1, 1 },
  { string50, fn_set, 2, 126 },
  { string51, fn_streamp, 1, 1 },
  { string52, fn_eq, 2, 2 },
  { string53, fn_car, 1, 1 },
  { string54, fn_car, 1, 1 },
  { string55, fn_cdr, 1, 1 },
  { string56, fn_cdr, 1, 1 },
  { string57, fn_caar, 1, 1 },
  { string58, fn_cadr, 1, 1 },
  { string59, fn_cadr, 1, 1 },
  { string60, fn_cdar, 1, 1 },
  { string61, fn_cddr, 1, 1 },
  { string62, fn_caaar, 1, 1 },
  { string63, fn_caadr, 1, 1 },
  { string64, fn_cadar, 1, 1 },
  { string65, fn_caddr, 1, 1 },
  { string66, fn_caddr, 1, 1 },
  { string67, fn_cdaar, 1, 1 },
  { string68, fn_cdadr, 1, 1 },
  { string69, fn_cddar, 1, 1 },
  { string70, fn_cdddr, 1, 1 },
  { string71, fn_length, 1, 1 },
  { string72, fn_list, 0, 127 },
  { string73, fn_reverse, 1, 1 },
  { string74, fn_nth, 2, 2 },
  { string75, fn_assoc, 2, 2 },
  { string76, fn_member, 2, 2 },
  { string77, fn_apply, 2, 127 },
  { string78, fn_funcall, 1, 127 },
  { string79, fn_append, 0, 127 },
  { string80, fn_mapc, 2, 127 },
  { string81, fn_mapcar, 2, 127 },
  { string82, fn_mapcan, 2, 127 },
  { string83, fn_add, 0, 127 },
  { string84, fn_subtract, 1, 127 },
  { string85, fn_multiply, 0, 127 },
  { string86, fn_divide, 1, 127 },
  { string87, fn_mod, 2, 2 },
  { string88, fn_oneplus, 1, 1 },
  { string89, fn_oneminus, 1, 1 },
  { string90, fn_abs, 1, 1 },
  { string91, fn_random, 1, 1 },
  { string92, fn_maxfn, 1, 127 },
  { string93, fn_minfn, 1, 127 },
  { string94, fn_noteq, 1, 127 },
  { string95, fn_numeq, 1, 127 },
  { string96, fn_less, 1, 127 },
  { string97, fn_lesseq, 1, 127 },
  { string98, fn_greater, 1, 127 },
  { string99, fn_greatereq, 1, 127 },
  { string100, fn_plusp, 1, 1 },
  { string101, fn_minusp, 1, 1 },
  { string102, fn_zerop, 1, 1 },
  { string103, fn_oddp, 1, 1 },
  { string104, fn_evenp, 1, 1 },
  { string105, fn_integerp, 1, 1 },
  { string106, fn_numberp, 1, 1 },
  { string107, fn_floatfn, 1, 1 },
  { string108, fn_floatp, 1, 1 },
  { string109, fn_sin, 1, 1 },
  { string110, fn_cos, 1, 1 },
  { string111, fn_tan, 1, 1 },
  { string112, fn_asin, 1, 1 },
  { string113, fn_acos, 1, 1 },
  { string114, fn_atan, 1, 2 },
  { string115, fn_sinh, 1, 1 },
  { string116, fn_cosh, 1, 1 },
  { string117, fn_tanh, 1, 1 },
  { string118, fn_exp, 1, 1 },
  { string119, fn_sqrt, 1, 1 },
  { string120, fn_log, 1, 2 },
  { string121, fn_expt, 2, 2 },
  { string122, fn_ceiling, 1, 2 },
  { string123, fn_floor, 1, 2 },
  { string124, fn_truncate, 1, 2 },
  { string125, fn_round, 1, 2 },
  { string126, fn_char, 2, 2 },
  { string127, fn_charcode, 1, 1 },
  { string128, fn_codechar, 1, 1 },
  { string129, fn_characterp, 1, 1 },
  { string130, fn_stringp, 1, 1 },
  { string131, fn_stringeq, 2, 2 },
  { string132, fn_stringless, 2, 2 },
  { string133, fn_stringgreater, 2, 2 },
  { string134, fn_sort, 2, 2 },
  { string135, fn_stringfn, 1, 1 },
  { string136, fn_concatenate, 1, 127 },
  { string137, fn_subseq, 2, 3 },
  { string138, fn_readfromstring, 1, 1 },
  { string139, fn_princtostring, 1, 1 },
  { string140, fn_prin1tostring, 1, 1 },
  { string141, fn_logand, 0, 127 },
  { string142, fn_logior, 0, 127 },
  { string143, fn_logxor, 0, 127 },
  { string144, fn_lognot, 1, 1 },
  { string145, fn_ash, 2, 2 },
  { string146, fn_logbitp, 2, 2 },
  { string147, fn_eval, 1, 1 },
  { string148, fn_globals, 0, 0 },
  { string149, fn_locals, 0, 0 },
  { string150, fn_makunbound, 1, 1 },
  { string151, fn_break, 0, 0 },
  { string152, fn_read, 0, 1 },
  { string153, fn_prin1, 1, 2 },
  { string154, fn_print, 1, 2 },
  { string155, fn_princ, 1, 2 },
  { string156, fn_terpri, 0, 1 },
  { string157, fn_readbyte, 0, 2 },
  { string158, fn_readline, 0, 1 },
  { string159, fn_writebyte, 1, 2 },
  { string160, fn_writestring, 1, 2 },
  { string161, fn_writeline, 1, 2 },
  { string162, fn_restarti2c, 1, 2 },
  { string163, fn_gc, 0, 0 },
  { string164, fn_room, 0, 0 },
  { string165, fn_saveimage, 0, 1 },
  { string166, fn_loadimage, 0, 1 },
  { string167, fn_cls, 0, 0 },
  { string168, fn_pinmode, 2, 2 },
  { string169, fn_digitalread, 1, 1 },
  { string170, fn_digitalwrite, 2, 2 },
  { string171, fn_analogread, 1, 1 },
  { string172, fn_analogwrite, 2, 2 },
  { string173, fn_delay, 1, 1 },
  { string174, fn_millis, 0, 0 },
  { string175, fn_sleep, 1, 1 },
  { string176, fn_note, 0, 3 },
  { string177, fn_edit, 1, 1 },
  { string178, fn_pprint, 1, 2 },
  { string179, fn_pprintall, 0, 1 },
  { string180, fn_require, 1, 1 },
  { string181, fn_listlibrary, 0, 0 },
  { string182, fn_drawpixel, 2, 3 },
  { string183, fn_drawline, 4, 5 },
  { string184, fn_drawrect, 4, 5 },
  { string185, fn_fillrect, 4, 5 },
  { string186, fn_drawcircle, 3, 4 },
  { string187, fn_fillcircle, 3, 4 },
  { string188, fn_drawroundrect, 5, 6 },
  { string189, fn_fillroundrect, 5, 6 },
  { string190, fn_drawtriangle, 6, 7 },
  { string191, fn_filltriangle, 6, 7 },
  { string192, fn_drawchar, 3, 6 },
  { string193, fn_setcursor, 2, 2 },
  { string194, fn_settextcolor, 1, 2 },
  { string195, fn_settextsize, 1, 1 },
  { string196, fn_settextwrap, 1, 1 },
  { string197, fn_fillscreen, 0, 1 },
  { string198, fn_setrotation, 1, 1 },
  { string199, fn_invertdisplay, 1, 1 },
};
