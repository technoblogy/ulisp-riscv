...
const char string184[] PROGMEM = "analogwriteresolution";
...
const char string192[] PROGMEM = "format";
...
const char string214[] PROGMEM = ":led-builtin";
const char string215[] PROGMEM = ":high";
const char string216[] PROGMEM = ":low";
const char string217[] PROGMEM = ":input";
const char string218[] PROGMEM = ":input-pullup";
const char string219[] PROGMEM = ":input-pulldown";
...
const tbl_entry_t lookup_table[] PROGMEM = {
  ...
  { string184, fn_analogwriteresolution, 0x11 },
  { string185, fn_delay, 0x11 },
  { string186, fn_millis, 0x00 },
  { string187, fn_sleep, 0x11 },
  { string188, fn_note, 0x03 },
  { string189, fn_edit, 0x11 },
  { string190, fn_pprint, 0x12 },
  { string191, fn_pprintall, 0x01 },
  { string192, fn_format, 0x2F },
  { string193, fn_require, 0x11 },
  { string194, fn_listlibrary, 0x00 },
  ...
  { string213, NULL, 0x00 },
  { string214, (fn_ptr_type)LED_BUILTIN, 0 },
  { string215, (fn_ptr_type)HIGH, DIGITALWRITE },
  { string216, (fn_ptr_type)LOW, DIGITALWRITE },
  { string217, (fn_ptr_type)INPUT, PINMODE },
  { string218, (fn_ptr_type)INPUT_PULLUP, PINMODE },
  { string219, (fn_ptr_type)INPUT_PULLDOWN, PINMODE },
